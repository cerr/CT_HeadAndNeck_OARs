...
import itertools
import model_wrapper.util.util as util
from model_wrapper.util.image_pool import ImagePool
...
class cycle_gan_unet_ct_seg_baseline(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.num_organ=11 #Define no. output structures here
    ...
    def net_G_A_A2B_Segtest_image(self):
        ...
        test_A_data=test_A_data[:,256*2:256*2,:]
        LP_map_data=LP_map_data[:,256*2:256*2,:]
        RP_map_data=RP_map_data[:,256*2:256*2,:]
